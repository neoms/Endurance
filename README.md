...
- **话题范围守卫**：AI 只讨论《星际穿越》相关话题；与电影无关的问题统一回复「别闲聊了，我们还是把注意力放在这次关乎人类未来的星际航行吧！」，个人对话与群组对话均生效；除提示词约束外，另有代码层确定性拦截（无关话题关键词分类 + 中英文提示词注入检测），防止用户引导 AI 越界（详见 `docs/DESIGN.md` §4.10）。
